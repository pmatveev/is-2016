...
CREATE TABLE GRANT_TRANSITION_MAPPING (
	ID INT (18) NOT NULL AUTO_INCREMENT,
	OFFICER_GRANT_ID INT (18) NOT NULL,
	PROJECT_TRANSITION_ID INT (18),
	STATUS_TRANSITION_ID INT (18),
	PRIMARY KEY (ID)
	);
...
ALTER TABLE GRANT_TRANSITION_MAPPING ADD INDEX FKGRANT_TRAN512375 (PROJECT_TRANSITION_ID),
	ADD CONSTRAINT FKGRANT_TRAN512375 FOREIGN KEY (PROJECT_TRANSITION_ID) REFERENCES PROJECT_TRANSITION (ID);

ALTER TABLE GRANT_TRANSITION_MAPPING ADD INDEX FKGRANT_TRAN480106 (STATUS_TRANSITION_ID),
	ADD CONSTRAINT FKGRANT_TRAN480106 FOREIGN KEY (STATUS_TRANSITION_ID) REFERENCES STATUS_TRANSITION (ID);

ALTER TABLE GRANT_TRANSITION_MAPPING ADD INDEX FKGRANT_TRAN730419 (OFFICER_GRANT_ID),
	ADD CONSTRAINT FKGRANT_TRAN730419 FOREIGN KEY (OFFICER_GRANT_ID) REFERENCES OFFICER_GRANT (ID);
...
CREATE INDEX ISSUE_IDT ON ISSUE (
 ...
 DROP TABLE GRANT_TRANSITION_MAPPING;
